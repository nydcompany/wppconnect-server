...
export default class chatWootClient {
  constructor(config, session) {
    this.config = config;
    this.mobile_name = this.config.mobile_name ? this.config.mobile_name : `Whatsplus`;
    this.mobile_number = this.config.mobile_number ? this.config.mobile_number : '595971650095';
    this.sender = {
